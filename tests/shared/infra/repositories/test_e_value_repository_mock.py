...
class TestEValueRepositoryMock:
    def test_save_e_value(self):
        e_value = E_Value(e_id="f1cdc4ff-0606-4723-846e-0c4d132c99b9", n_value=10, b_section=0.9, edl_prcnt=66.0, e_external=20000.0, a_area=544.0, fd_value=0.7)
    ...
    def test_save_e_value_duplicate_id(self):
        e_value = E_Value(e_id="f1cdc4ff-0606-4723-846e-0c4d132c99b9", n_value=10, edl_prcnt=66.0, b_section=0.9, e_external=20000.0, a_area=544.0, fd_value=0.7)
        repo = EValueRepositoryMock()
        repo.save_e_value(e_value)
        # Attempt to save the same value again should raise ValueError
        e_value_duplicate = E_Value(e_id="f1cdc4ff-0606-4723-846e-0c4d132c99b9", n_value=1, edl_prcnt=65.0, b_section=0.9, e_external=2000.0, a_area=54.0, fd_value=0.1)
    ...
    def test_calculate_e_value(self):
        repo = EValueRepositoryMock()
        e_value = E_Value(e_id="00000000-0000-0000-0000-000000000000", n_value=10, edl_prcnt=66.0, b_section=0.9, e_external=20000.0, a_area=544.0, fd_value=0.7)
